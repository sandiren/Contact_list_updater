...
${contact.address ? `ADR;CHARSET=utf-8:;;${contact.address};;;;` : ''}
...
END:VCARD`;
    ...
    try {
      ...
      qrContainer.className = 'd-inline-block text-center p-2';
      ...
      console.error(`Could not generate QR code for ${contact.name}:`, err);
    }
  });
}
